...
class Person:
    ...
    colliding = False
    meta = {} # lets others store meta data for us
    labels = {} # special labels others may want to drop in
    ...
    def draw(self, frame):
        # square
        alpha = 100 * (self.life / self._full_life)
        ...
        cv2.putText(frame, self.name, (self._x1, self._y2 + 15), font, 0.8, color)
